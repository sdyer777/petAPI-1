...
post '/addPet' do
  ...
  puts "GOT TO ADD PET - zz params next:"
  puts "GOT TO ADD PET - params=["  + params.to_s + "]"
  puts "GOT TO ADD PET - headers=["  + headers.to_s + "]"
  puts "GOT TO ADD PET - name=[" + params[:name] + "]"
  puts "GOT TO ADD PET - type=[" + params[:type] + "]"
